;if(CloudflareApps.matchPage(CloudflareApps.installs['XR9wYQ9vO23Y'].URLPatterns)){(function(){'use strict'
if(!window.addEventListener)return
var options=CloudflareApps.installs['XR9wYQ9vO23Y'].options
var element
...
window.CloudflareApps.installs['XR9wYQ9vO23Y'].scope={setOptions:function setOptions(nextOptions){options=nextOptions
